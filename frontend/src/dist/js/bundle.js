...
var _ = {
  ...
  setToggle: function setToggle(node, className) {
    return node.classList.toggle(className);
  },
  contains: function contains(node, className) {
    return node.classList.contains(className);
  },
  removeTransform: function removeTransform(node, attributeName) {
  ...
  setStorageItem: function setStorageItem(name, item) {
    return localStorage.setItem(name, JSON.stringify(item));
  },
  getStorageItem: function getStorageItem(item) {
...
/*!**********************************!*\
  ...
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ "./frontend/src/js/util.js");


var body = _util_js__WEBPACK_IMPORTED_MODULE_0__._.$('body');
